...
const template_resolver_base_1 = require("./base/template.resolver.base");
const Template_1 = require("./base/Template");
const template_service_1 = require("./template.service");
let TemplateResolver = class TemplateResolver extends template_resolver_base_1.TemplateResolverBase {
